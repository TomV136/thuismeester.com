                ...
                <ul className="hidden items-center gap-8 md:flex">
                    {navLinks.map((link) => (
                        <li key={link.href}>
                            <Link
                                href={link.href}
                                className={`text-sm transition-colors duration-150 hover:text-green ${pathname === link.href
                    ...
                    <ul className="section-wrapper flex flex-col gap-4 py-6">
                        {navLinks.map((link) => (
                            <li key={link.href}>
                                <Link
                                    href={link.href}
                                    className={`block text-base transition-colors hover:text-green ${pathname === link.href ? "font-medium text-green" : "text-ink-soft"
                                        }`}
                                >
                                    {link.label}
                                </Link>
